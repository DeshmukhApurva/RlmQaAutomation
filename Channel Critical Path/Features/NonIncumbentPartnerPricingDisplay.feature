...
Scenario: 
	Rally Test Case ID: TC5261,TC5262,TC5263 - Account: "Prevent Portal Download" checkbox on  Account Details Pa,Asset Page - Partner Account 1 and 2 related fields on Opportunity Page,Service Contracts Page - Partner Account 1 and 2 related fields on Opportunity Page 
...
Scenario: 
	Rally Test Case ID: TC5266,TC5269 - Opportunity Page - Partner Account 1 and 2 related fields on Opportunity Page 
	When I click on the "Opportunities" grid tab 
	And I open the existing opportunity 
	Then I verify the partner account fields 
	When I click on the "Opportunities" grid tab 
...
Scenario: 
	Rally Test Case ID: TC5267,TC5268,TC5270 - Quote Page - Partner Account 1 and 2 related fields on Quote Page,Populating value in Partner Account 1/2 related fields when user creates PO,Opportunity and Quote Page: Populating value in Partner Account 1/2 related fields when user creates PO which is syncing as "To Master Opportunity" 
	When I click on the "Opportunities" grid tab 
	And I open the existing opportunity 
	Then I verify the partner account fields 
	And I open the quote 
...
Scenario: 
	Rally Test Case ID: TC5272,TC5274 - Quote Page: Populating updated value in Partner Account 1/2 related fields when user creates quote manually and associated to a partner opportunity,Updating value in Partner Account 1/2 related fields when user updates the partner opportunity field value of Quote 
	When I click on the "Opportunities" grid tab 
	And I open the existing opportunity 
	Then I verify the partner account fields 
...
Scenario: 
	Rally Test Case ID: TC5273,TC5275,TC5276 - Opportunity and Quote Page: Populating  value in Partner Account 1/2 related fields when user creates quote manually and associat it to a partner opportunity and syncs it,Updating value in Partner Account 1/2 related fields when user updates the partner opportunity field value of syncing Quote,Removing PO reference from Quote when it is Syncing 
	When I click on the "Opportunities" grid tab 
	And I open the existing opportunity 
	Then I verify the partner account fields 
	And I click on the "New Quote" 
