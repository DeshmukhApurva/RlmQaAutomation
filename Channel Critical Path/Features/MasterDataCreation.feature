...
Scenario: Channel: Channel Setup
	...
	Then I move Sales stages for Partners from and add Number of Days Between Updates and Days Before Expiration "Not Available to Partners" to "Available to Partners"
	Then I move Sales stages for pipeline from and add Number of Days Between Updates and Days Before Expiration "Hidden from Pipeline" to "Display in Pipeline"
	When I click on "All Tabs" tab
	When I Navigate to "ServiceSource Setup" tab
