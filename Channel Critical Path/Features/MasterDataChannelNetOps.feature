...
Scenario: Channel: Generate Partner Opportunity 
     ...
     When I create Source Opportunity with Line Items and resolve it and rename it as "TwoTierAutomationRO" 
     And I click on "Add New Partner Opportunity" button
     ...
     And I rename the partner opportunity name as "TwoTierAutomationPO"
     And I click on the "Grant Access"
