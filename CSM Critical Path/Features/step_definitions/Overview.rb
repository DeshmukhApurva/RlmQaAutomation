...
And(/^I mark the task as Not Started$/) do
  begin
    ...
    listArrow = find(:xpath,'//a[contains(text(),"PES FC Task-Overview")]/parent::h3/parent::div/i')[:class]
    puts listArrow
    
    puts listArrow.include? "glyphicon-chevron-right"
    if listArrow.include? "glyphicon-chevron-right"
