...
Then(/^I able to see the "([^"]*)" results$/) do |category|
  begin
    ...
    if page.has_css?(".ui-widget")
      ...
      sleep 3
      arg1 = getDetails "Focus Category"
      if first(".font-light").text.include?(arg1["Display Name"])
        puts "Successfully see the #{arg1["Display Name"]} #{category} name"
      else
        putstr "Failed to see the #{arg1["Display Name"]} #{category} name"
      end
    else
...
Then(/^I should not able to see the "([^"]*)" results$/) do |category|
  begin
    ...
    if page.has_css?(".ui-widget")
      ...
      sleep 3
      arg1 = getDetails "Focus Category"
      unless first(".font-light").text == arg1["Display Name"]
        putstr "Able to see the #{arg1["Display Name"]} #{category} name"
      else
        puts "Not able to see the #{arg1["Display Name"]} #{category} name"
      end
    else
