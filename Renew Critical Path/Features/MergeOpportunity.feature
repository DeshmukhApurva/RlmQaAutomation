...
Scenario:
Rally Test Case ID: TC3511,TC3514,TC3515,TC3516 - Merge Opportunities - Opportunities,Highlights the rows of conflicting data,Editable fields only,Select All link 
...
Scenario:
Rally Test Case ID: TC3523 - Merge Opportunities - Validation Message (Consolidate Opportunity) 
	When I click on "Opportunities" link 
	And I click on "Go!" button from opportunity page 
	And I select the opportunities 
...
Scenario:
Rally Test Case ID: TC3517 - Merge Opportunities - Validation Message (Select two Opportunities) 
	When I click on "Opportunities" link 
	And I click on "Go!" button from opportunity page 
	And I click on "Merge" button 
...
Scenario:
Rally Test Case ID: TC3518 - Merge Opportunities - Validation Message(More than two Opportunities) 
	When I click on "Opportunities" link 
	And I click on "Go!" button from opportunity page 
...
Scenario:
Rally Test Case ID: TC3512,TC3513,TC3519,TC3520,TC3521 - Merge Opportunities - Verify Linking a Renewal Relationship Object 
	When I click on "Opportunities" link 
	And I click on "New" button 
	And I create the new opportunity 
	And I click on "Choose Price Book" button 
