...
Scenario: Renew: Generate Opp 
    ...
    When I create Source Opportunity with Line Items and resolve it and rename it as "SourceOpportunity9" 
    When I create Source Opportunity with Line Items and resolve it and rename it as "FiscalOpportunity" 
    When I create Source Opportunity with Line Items and resolve it and rename it as "RenewTesting" 
