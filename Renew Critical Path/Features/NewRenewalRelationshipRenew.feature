@RenOpportunity
@RenNewRenewalRelationshipFeature
...
@RenInsideFiscalYear
Scenario:Rally -ID: TC4638: Renewal Relationship - End Date in fiscal year range
...
@RenOutsideFiscalYear
Scenario:Rally -ID: TC4639,TC4640: Renewal Relationship - End Date outside fiscal year range - Std Fiscal Year is set
  When I Navigate to "Opportunities" tab
  Then I select the opportunity to set the date
