...
Scenario: 
	Rally Test Case ID: TC3243,TC3244 : AddOn Opportunity - Destination Service Contract,AddOn Opportunity - Destination Renewal Opportunity 
...
Scenario: 
	Rally Test Case ID: TC3247,TC3248,TC3250 : AddOn Opportunity - Validation Message (Pricebook), AddOn Opportunity - Validation Message, AddOn Opportunity - Same Currency of Opportunity & Service Contract 
	When I click on "Opportunities" link 
	And I click on "New" button 
...
Scenario: 
    ...
    When I click on "Opportunities" link 
	And I click on "New" button 
	And I enter mandatory details in "Destination Renewal Opportunity" opportunity 
	And I click on "Choose Price Book" button 
	Then I Choose the Pricebook for the product 
