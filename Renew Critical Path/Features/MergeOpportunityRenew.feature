...
Scenario:
Rally Test Case ID: TC3215,TC3218,TC3219,TC3220 : Merge Opportunities - Opportunities,Merge Opportunities - Select All link, Merge Opportunities - Covered assets and covered product Display, Merge Opportunities - "Renewal" check 
	...
	#And I select Master Merge Opportunity
...
Scenario:
Rally Test Case ID: TC3227 : Merge Opportunities - Validation Message (Consolidate Opportunity) 
	When I click on "Opportunities" link 
	And I click on "Go!" button from opportunity page 
	And I select the opportunities 
...
Scenario:
Rally Test Case ID: TC3221 : Merge Opportunities - Validation Message (Select two Opportunities) 
	When I click on "Opportunities" link 
	And I click on "Go!" button from opportunity page 
	And I click on "Merge" button 
...
Scenario:
Rally Test Case ID: TC3222 : Merge Opportunities - Validation Message(More than two Opportunities) 
	When I click on "Opportunities" link 
	And I click on "Go!" button from opportunity page 
...
Scenario:
Rally Test Case ID: TC3216,TC3217,TC3223,TC3224,TC3225 : Merge Opportunities - Highlights the rows of conflicting data, Merge Opportunities - Editable fields only, Merge Opportunities - Verify Linking a Renewal Relationship Object, Merge Opportunities - Header Amount Recalculation, Merge Opportunities - Product Line Items removal from Source Opp 
	When I click on "Opportunities" link 
	And I click on "New" button 
	And I create the new opportunity 
	And I click on "Choose Price Book" button 
